...
export function FooterThree() {
  return (
    <section className="fixed overflow-hidden py-4 fixed bottom-0 w-full bg-black z-50">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <button href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-white hover:border-gray-400">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.instagram.com/mr_vicky__official__/">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-white hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
